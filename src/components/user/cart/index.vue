        ...
        <table class="cart-table" data-product-id="productId">
          <tr v-for="cart in cartList" :key="cart.productId">
            ...
            <td class="cart-cell cell-count">
              ...
              <input class="count-input" :value="cart.quantity" @blur="changeCount(cart, 'update_count', $event)" data-max="cart.productStock"/>
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
       ...
       * @param  {string} type  对应的mutations值[plus_count增加, <strong>minus_count</strong> 减少, delete_product 删除]
       */
      ...
      changeCount(cart, type, event) {
        cart.quantity = event.currentTarget.value;
        this.actionCart(cart, type);
      }
    }
  };
</script>
